...
public class ESTerminal {
    ...
    public LocalDateTime lerDataHoraLocal(String rotulo, int numeroDeEspacos) {
        LocalDateTime data = null;
        String dateString = lerString(rotulo + "(dia-mês-ano hora:minutos)", numeroDeEspacos);
        data = LocalDateTime.parse(dateString, DateTimeFormatter.ofPattern("dd-MM-yyyy' 'HH:mm"));
        return data;
    }
    ...
    public int enterParaContinuar(int nespacos) {
        escreverEspacos(nespacos);

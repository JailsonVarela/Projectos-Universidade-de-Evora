 ...
 */
public class ClienteGeralTerminalApp implements TerminalAppInterface {
    private final ServicosClienteGeralInterface servicosClienteGeral;
    ...
    public ClienteGeralTerminalApp(ServicosClienteGeralInterface servicosClienteGeral, ServicosAuxiliaresInterface servicosAuxiliares) {
        this.servicosClienteGeral = servicosClienteGeral;
    ...
    private int menuPrincipal() {
        ...
        do {
            ...
            this.esTerminal.escreverMensagem("6. Consultar histórico de aluguer de um veículo", 4);
    ...
    private void registarNovoVeiculo() throws RemoteException {
        try {
            ...
            this.servicosClienteGeral.registoNovoVeiculo(matricula, modelo, tipoDeVeiculo, localizacaoAtual);
    ...
    public void registarClientes() throws RemoteException {
        try {
            ...
            this.servicosClienteGeral.registoCliente(nome, documentoDeIdentificacao, contacto);
    ...
    public void registarNovoAluguer() throws RemoteException {
        try {
            ...
            Veiculo veiculo = this.terminalComponents.escolhaUm("Selecione o veiculo", this.servicosClienteGeral.listarVeiculosDisponiveisParaAluguer(), 4);
            if(veiculo == null) {
            ...
            this.servicosClienteGeral.registoNovoAluguer(veiculo.getId(), cliente.getId(), (float) valorDePagamento, dataDeInicio, tempo);
    ...
    public void listarVeiculosDisponiveisParaAluguer() throws RemoteException {
        List<Veiculo> veiculosDisponiveis = this.servicosClienteGeral.listarVeiculosDisponiveisParaAluguer();
    ...
    public void listarLocalizacaoDeVeiculosAlugados() throws RemoteException {
        List<String> localizacaoDeVeiculosAlugados = this.servicosClienteGeral.listarLocalizacoesVeiculosAlugados();
    ...
    public void consultarHistoricoDeAluguelDeVeiculo() throws RemoteException {
        try {
            this.esTerminal.escreverTitulo("CONSULTAR HISTÓRICO DE ALGUER DE VEICULO");
            this.esTerminal.escreverLinhas(1);
            ...
            List<Aluguer> listaDeAluguer = this.servicosClienteGeral.consultarHistoricoAluguerUmVeiculoEspecifico(veiculo.getId());
        ...
        do {
            try {
                ...
                switch(escolha) {
                    ...
                    case 6 -> consultarHistoricoDeAluguelDeVeiculo();
                }
            } catch (RemoteException ex) {
                Logger.getLogger(ClienteGeralTerminalApp.class.getName()).log(Level.SEVERE, null, ex);
            }
        } while(escolha > 0);
    }
